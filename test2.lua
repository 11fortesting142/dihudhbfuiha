...
local window = summitLib:CreateWindow({Name = "ОНО РАБОТАЕТ",AccentColor3 = Color3.new(1, 0.235294, 0.337255)})
local Tab1 = window:CreateTab({Name = "хуйня", Icon = 'rbxassetid://7733765307'})
...
Tab1:CreateSlider({Default = 250, Minimum = 16, Maximum = 500, Callback = function(Value)
	print(Value) -- returns a whole number
	SliderValue = Value
end})

Tab1:CreateToggle({Text = "This is a Toggle!",Default = false,Callback = function(Value)
